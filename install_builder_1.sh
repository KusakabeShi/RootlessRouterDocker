...
apt-get -y install unzip golang-go python3-setuptools python3 python3-pip python3-dev g++ gcc \
                   vpp vpp-plugin-core vpp-dbg vpp-dev libmemif libmemif-dev wireguard-tools \
