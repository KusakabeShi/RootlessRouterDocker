...
apt-get -y install mc mtr multitail netcat nethogs netpipes nikto nmap nnn oysttyer parallel pgadmin3 polipo postgresql powertop 
apt-get -y install pydf qalc qbittorrent-nox ranger remind rsstail rsyncrypto rtorrent screen searchandrescue siege silversearcher-ag 
apt-get -y install sl slashem slurm socat sqlite3 tig tor tor-geoipdb torsocks tpp tsung ttyrec vifm wyrd yersinia zlib1g-dev zlib1g-dev
